...
-- Insert sample departments with proper UUIDs
INSERT INTO public.departments (name, color, description) VALUES
  ('Computer Science', 'hsl(217, 91%, 60%)', 'Department of Computer Science'),
  ('Mathematics', 'hsl(142, 76%, 36%)', 'Department of Mathematics'),
  ('Physics', 'hsl(262, 83%, 58%)', 'Department of Physics'),
  ('Engineering', 'hsl(25, 95%, 53%)', 'Department of Engineering');
